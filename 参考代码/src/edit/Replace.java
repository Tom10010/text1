		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					replace.setLocationRelativeTo(Replace.window.frame);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
