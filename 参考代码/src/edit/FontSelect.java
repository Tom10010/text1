...
public class FontSelect extends JDialog {
	...
	public FontSelect() {
			...
			getContentPane().add(buttonPane);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						window.changeTextFont(textFieldFont.getText(),textFieldStyle.getText(),textFieldSize.getText());
						dispose();
					}
				});
		...
		}
		{
			...
			lblNewLabel.setFont(new java.awt.Font("宋体", java.awt.Font.PLAIN, 15));
		...
		textAreaSample.setFont(new Font("黑体",Font.BOLD,20));
		...
		{
			textFieldStyle = new JTextField("粗体");
	...
	private void  fontSampleFresh(){
		...
		this.textAreaSample.setFont(new Font(textFieldFont.getText(),charStyle,
				Integer.valueOf(textFieldSize.getText())));
	}
}
